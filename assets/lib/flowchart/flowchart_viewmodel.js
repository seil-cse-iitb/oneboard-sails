...
(function () {
	...
	//
	flowchart.ChartViewModel = function (chartDataModel, connectionCallback) {
		...
		//
		this.createNewConnection = function (startConnector, endConnector, callback) {
			...
			this.connectionCallback(connectionDataModel);
		};
