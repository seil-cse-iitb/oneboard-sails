...
.component('priority', {
    templateUrl: 'components/equipments/priority.html',
    // controller: function($scope, $element, $attrs, Equipment) {
    //     var ctrl = this;
    //     ctrl.priority.properties.state = ctrl.priority.properties.state || false;
    //     $scope.switch = function(equipment) {
    //         Equipment.actuate({ id: equipment.id }, { msg: "P" + Number(!equipment.properties.state), state: !equipment.properties.state });
    //     }
    // },
    bindings: {
        priority: '<'
